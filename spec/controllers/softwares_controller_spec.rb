...
RSpec.describe SoftwaresController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all softwares as @softwares" do
      ...
      expect(assigns(:softwares)).to eq([software])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested software as @software" do
      ...
      expect(assigns(:software)).to eq(software)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new software as @software" do
      ...
      expect(assigns(:software)).to be_a_new(Software)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created software as @software" do
        post :create, {:software => valid_attributes}, valid_session
        expect(assigns(:software)).to be_a(Software)
        expect(assigns(:software)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved software as @software" do
        post :create, {:software => invalid_attributes}, valid_session
        expect(assigns(:software)).to be_a_new(Software)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested software" do
        software = Software.create! valid_attributes
        put :update, {:id => software.to_param, :software => new_attributes}, valid_session
        software.reload
    ...
    context "with invalid params" do
      it "assigns the software as @software" do
        software = Software.create! valid_attributes
        put :update, {:id => software.to_param, :software => invalid_attributes}, valid_session
        expect(assigns(:software)).to eq(software)
      end
