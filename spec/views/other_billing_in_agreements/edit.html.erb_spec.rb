...
RSpec.describe "other_billing_in_agreements/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit other_billing_in_agreement form" do
    render

    assert_select "form[action=?][method=?]", other_billing_in_agreement_path(@other_billing_in_agreement), "post" do
